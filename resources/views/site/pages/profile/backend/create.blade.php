                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Add New Profile
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('profiles.store') }}" method="POST" role="form" id="jquery-val-form" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="basic-addon-name">Name(*)</label>
                                                    <input type="hidden" class="hidden" name="req_id" value="{{ $req_id }}" />
                                            ...
                                            <!--<div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="dob-bootstrap-val">Date of Birth</label>
                                                    <input type="text" class="form-control flatpickr-validation flatpickr" id="dob-bootstrap-val" name="date_of_birth" value="{{ old('date_of_birth', $profile->date_of_birth) }}" />
                                            ...
                                            <div class="col-md-6 col-12">
                                                @if($profile->photo!=null)
                                                    <div class="form-group">
                                                        <label for="customFile1">Requested Profile pic</label>
                                                        <div class="custom-file">
                                                            <input type="hidden" name="photoreq" value="{{ $profile->photo }}"/>
                                                ...
                                                <div class="form-group" style="margin-top: 30px">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="customFile1" name="photo" @if($profile->photo==null) required @endif value="{{ old('photo', $profile->photo) }}"/>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control form-control-sm" id="color" name="color" required>
                                                        <option disabled selected>Select an option</option>
                                                        <option value="Not Biased">Not Biased  (Green)</option>
                                                        <option value="Neutral">Neutral (Yellow)</option>
                                                        <option value="Biased">Biased (Red)</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="cf1"/>
                                                ...
                                                <div id="cfbox1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="custom1title" class="form-control" placeholder="Title" name="custom1title" required />
                                                        <div class="valid-feedback">Looks good!</div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="custom1value" class="form-control" placeholder="Value" name="custom1value" required />
                                                        <div class="valid-feedback">Looks good!</div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input" id="cf2"/>
                                                ...
                                                <div id="cfbox2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="custom2title" class="form-control" placeholder="Title" name="custom2title" required />
                                                        <div class="valid-feedback">Looks good!</div>
                                                        <div class="invalid-feedback">Please enter Field Title.</div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="custom2value" class="form-control" placeholder="Value" name="custom2value" required />
                                                        <div class="valid-feedback">Looks good!</div>
                                                        <div class="invalid-feedback">Please enter Field Value.</div>
                                                    </div>
                                                </div>
